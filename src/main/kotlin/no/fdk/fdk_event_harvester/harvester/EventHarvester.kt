...
class EventHarvester(
    ...
    fun harvestEvents(trigger: HarvestTrigger, harvestDate: Calendar): HarvestReport? =
            ...
            try {
                ...
                when (val jenaWriterType = jenaTypeFromAcceptHeader(trigger.acceptHeader)) {
                    ...
                    Lang.RDFNULL -> {
                        ...
                        parseRDFResponse(adapter.getEvents(trigger.dataSourceUrl, trigger.acceptHeader!!), jenaWriterType),
                        trigger.dataSourceId!!, trigger.dataSourceUrl, harvestDate, trigger.publisherId, trigger.forceUpdate, trigger.runId
                    )
                }
            } catch (ex: Exception) {
